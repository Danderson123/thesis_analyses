...
input_directory = glob.glob("pandora_assessment_with_AMR/*/summary_stats.k*.w*.txt")
...
ax1[1].set_ylim([0.95, 1])
ax1[1].set_xlim([-0.05, 1])
ax1[1].xaxis.set_major_locator(MultipleLocator(0.2))

# Add a single legend for the entire figure
fig1.legend(loc="center left", bbox_to_anchor=(1.005, 0.5), fontsize=18, title="", title_fontsize=18, frameon=False)
fig1.tight_layout()
fig1.savefig("result_plots_identity_vs_length.eval.png", dpi=600, bbox_inches="tight")
fig1.savefig("result_plots_identity_vs_length.eval.pdf", bbox_inches="tight")
plt.close()
...
# Add a single legend for the entire figure
fig2.legend(loc="center left", bbox_to_anchor=(1.005, 0.5), fontsize=18, title="", title_fontsize=18, frameon=False)
fig2.tight_layout()
fig2.savefig("result_plots_k_vs_w.eval.png", dpi=600, bbox_inches="tight")
fig2.savefig("result_plots_k_vs_w.eval.pdf", bbox_inches="tight")
plt.close()
