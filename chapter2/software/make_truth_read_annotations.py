...
if __name__=="__main__":
    ...
    for read in tqdm(reads):
        ...
        if genes:
            # store the genes
            if read_id == "f3524868-453e-48f4-8c15-7cbfbdaf3548":
                print(f"{read_id}_{read.reference_name}_{str(read_start)}_{read_end}", genes, read.reference_start, read.reference_end)
